...
/**
 * Admin's Members component which displays all members present in the group
 * @component
 * @returns {JSX.Element} - Members UI
 */
const Members = () => {
    ...
    <div className="home-container" style={{ justifyContent: 'flex-start', paddingTop: '0px', background: '#f5f6fa' }}>
      ...
      <div style={{ marginTop: '-60px', fontSize: '0.5emm' }}>
        ...
        <div className="member-list-container" style={{
          ...
          {/*Add, Delete, Update, and Home Button*/}
          </div>
           <div style={{
            display: 'flex',
            ...
            <button className="toggle-button" onClick={() => navigate('/Add')} style={buttonStyle}>Add Member</button>
            <button className="toggle-button" onClick={() => navigate('/Update')} style={buttonStyle}>Update Member</button>
            <button className="toggle-button" onClick={() => navigate('/Delete')} style={buttonStyle}>Delete Member</button>
            <button className="bottom_button" onClick={() => navigate('/Home')} style={buttonStyle}>Home</button>
          </div>
        </div>
      </div>
    </div>
