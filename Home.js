...
/**
 * Home component displays the main dashboard for logged-in admins
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* Welcome Message, Logout Link, and Home Button */}
        <div
          className="header"
          style={{
            marginTop: '18px',
        ...
        >
          ...
          <button
            ...
            onClick={() => handleNavigation('/balance-update')}
          >
            <FaMoneyBillWave size={26.1} />
            Balance Update
          </button>
          <button
            className="home-button"
            ...
            onClick={() => handleNavigation('/game-history')}
          >
            <FaGamepad size={26.1} />
            Game History
          </button>
          <button
            ...
            onClick={() => handleNavigation('/balance-history')}
          >
            <FaHistory size={26.1} />
            Balance History
          </button>
          <button
            ...
            onClick={() => handleNavigation('/Admin/balance')}
          >
            <FaWallet size={26.1} />
            Check Balance
          </button>
